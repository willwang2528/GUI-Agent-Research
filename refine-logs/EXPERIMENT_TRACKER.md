...
| S1-M1-02c | M1 | 重建 outcome-blind Stage A measurement | synthetic fixtures | full-block frame/stream/raw/A0/A1/exposure/role schemas、schema-first validator、negative matrix | MUST | **ROUND 7 SYNTHETIC GREEN / PROTOCOL REVISE** | v2 94/94 Stage A、104/104 组合回归、28/28 strict schemas PASS，覆盖 X58–X64 与 R02/R04/R06/R07/R09/R10/R11/R12/R15；仍缺 frozen case matcher、human dual-entailment 与 external raw/time/access/role authority |
...
| S1-M7-05 | M7 | Round 7 Stage A v2 / local-source battle | v2 mechanics + local archived bytes | R/C/P/E/M、R11 singleton、adapter authority ceiling | MUST | **SYNTHETIC ACCEPT / LOCAL BYTES ACCEPT / SCIENCE REJECT** | Stage A v2 指定 mechanics 与本地字节 literal projection 获独立窄 ACCEPT；whole protocol、source origin、production、Block A 与 Step 1 继续 REJECT |
